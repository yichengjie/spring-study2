...
import com.yicj.annotation.anno.CourseInfoAnnotation;
import com.yicj.annotation.anno.PersonInfoAnnotation;
...
public class AnnotationParser {
    ...
    public static  void  parseTypeAnnotation() throws ClassNotFoundException {
        Class clazz = Class.forName("com.yicj.annotation.client.ImoocCourse");
